...
public class FinancialPrice extends FinancialObject {
    ...
    public void setInitialValues() {
        ...
        String myString = "https://www.alphavantage.co/query?function=BATCH_STOCK_QUOTES&symbols=" + symbol + "&apikey=" + apiKey;
    ...
    @Override
    public boolean validateCallSymbol(String inputSymbol) throws IOException {  // Checking that the user input generates a valid API call

        String str = "https://www.alphavantage.co/query?function=BATCH_STOCK_QUOTES&symbols=" + inputSymbol + "&apikey=" + apiKey;
        boolean valid = true;
        ...
        while (line != null) {
            ...
            /* API call for BATCH_STOCK_QUOTES query never returns error even with wrong stock ticker input
              we can only check for [] in output to see that an invalid input was used.
             */
            if (line.contains("[]"))
                valid = false;
